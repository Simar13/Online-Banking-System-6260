 ...
 <div> 
  ...
  <tr>
    <td height="557" align="center" bgcolor="#F3F4EF"><p>&nbsp;</p>
      ...
      <tr>
        <td bgcolor="#FF0000"><span class="style2">Withdraw </span></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td width="236">Account Number</td>
        <td width="486"><input type="text" name="account" id="account" value="<%= request.getAttribute("account") %>" /></td>
      </tr>
      
      <tr>
        <td>Amount</td>
        <td><label>
          <input type="text" name="amount" id="amount" value="<%= request.getAttribute("amount") %>"/>
        </label></td>
      </tr>
      <tr>
        <td>Company Name</td>
        <td><input type="text" name="company" id="company" value="<%= request.getAttribute("company") %>"/></td>
      </tr>
