 ...
 <div> 
     ...
     <td height="118" bgcolor="#F3F4EF"><table width="1061" height="122" border="0">
         <tr>
           <td width="510" height="116"><table width="500" height="104" border="0" align="center">
               <tr >
                 <td width="229" height="98" align="right" bgcolor="#F0F0F0"><img src=".../Resources/Images/logo.jpg" width="95" height="95" /></td>
  ...
  <tr>
    <td height="557" align="center" valign="top" bgcolor="#F3F4EF"><p>&nbsp;</p>
      <p>&nbsp;</p>
      <table width="1015" height="40" border="0">
      <tr>
        <td width="380" align="right">Enter Customer Id</td>
...
<script>
  ...
  var numL= /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z]{8,12}$/g; 
	 ...
	 if (!numL.test(nric)){ 
       alert("The  id contain only Letters and number and its length should be more than 8");
	return false; 
		}
		}
</script>
