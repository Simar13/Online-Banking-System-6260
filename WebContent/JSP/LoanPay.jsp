...
<body>
<form id="form1" name="form1" method="post" action="/Online-Banking-System/LoanPayTwo">
  ...
  <tr>
    ...
    <table width="420" border="0" align="center">
     ...
     <c:forEach items="${loan}" var="loan">
      <tr>
        <td width="201"><span class="style2"> Pay Instalment</span></td>
        <td width="203">&nbsp;</td>
      </tr>
      <tr>
        <td> Loan Id</td>
        <td align="center"><label>
          <input type="text" name="loanid" id="loanid" readonly="readonly"  value="${loan.loanId}"/>
        </label></td>
      </tr>
      <tr>
        <td height="24" align="left">Duration(Year)</td>
        <td align="center" valign="middle"><input type="text" name="duration" id="duration" readonly="readonly" value="${loan.duration}"/></td>
      </tr>
      <tr>
        <td height="24" align="left">Gross Amount</td>
        <td align="center" valign="middle"><input type="text" name="grossamount" id="grossamount" readonly="readonly" value="${loan.grossAmount}"/></td>
      </tr>
      <tr>
        <td height="24" align="left">Paid Amount</td>
        <td align="center" valign="middle"><input type="text" name="paidamount" id="paidamount" readonly="readonly" value="${loan.paidAmount}"/></td>
      </tr>
      <tr>
        <td height="24" align="left">Installment to Pay</td>
        <td align="center" valign="middle"><input type="text" name="installment" id="installment" readonly="readonly" value="${loan.installment}" /></td>
      </tr>
      <tr>
        <td height="24" align="left">Principal</td>
        <td align="center" valign="middle"><input type="text" name="principal" id="principal" readonly="readonly" value="${loan.principal}"/></td>
      </tr>
      <tr>
        <td height="24" align="left">Outstanding Balance</td>
        <td align="center" valign="middle"><input type="text" name="outstanding" id="outstanding" readonly="readonly" value="${loan.outstanding}" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="center" valign="middle"><input type="text" name="interestrate" id="interestrate" readonly="readonly" value=" ${loan.interestRate}"/></td>
      </tr>
      <tr>
        <td height="24" align="left">&nbsp;</td>
        <td align="center" valign="middle"><input name="pay" type="submit" class="CsButton" id="pay" value="Pay" /></td>
      </tr>
         </c:forEach>
    </table>
    </td>
