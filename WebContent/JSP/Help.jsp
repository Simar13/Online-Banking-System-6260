...
<table width="100%" height="622" border="0">
 <div> 
  ...
  <tr >
    <td height="407" bgcolor="#F3F4EF"><table width="541" height="312" border="1" align="center">
      <tr>
        <td align="center"><h3>Most popular questions for this section:</h3>
          <ol>
            <li>Userid password is given to the coustomer while registering.</li>
            <li>Security question and answer for Interac e-Transfer are set by the user and receiver must know the password for receiving the money.</li>
            </ol>          </td>
      </tr>
    </table></td>
  </tr>
