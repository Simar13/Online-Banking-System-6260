...
<body>
<form id="form1" name="form1"  action="/Online-Banking-System/AdminMortgageAction">
<table width="1032" height="622" border="0">
 <div> 
  ...
  <tr background="../Resources/Images/download.png">
    <td height="407" align="center"><table border="1">
      <thead>
        <tr>
        <th width="79">mortgage Id</th>
          <th width="79">Customer Id</th>
           <th width="140">Downpayment</th>
          <th width="101">Annual income</th>
           <th width="140">Expenditure</th>
          <th width="101">Commodity price</th>
          <th width="140">mortgage Amount Requested</th>
      ...
      <tbody>
        <c:forEach items="${mortgage}" var="mortgage">
          <tr>
            <td><c:out value="${mortgage.mortgageId}" /></td>
            <td><c:out value="${mortgage.nric}" /></td>
            <td><c:out value="${mortgage.downPayment}" /></td>
            <td><c:out value="${mortgage.income}" /></td>
            <td><c:out value="${mortgage.expenditure}" /></td>
            <td><c:out value="${mortgage.price}" /></td>
            <td><c:out value="${mortgage.principal}" /></td>
            <td><c:out value="${mortgage.duration}" /></td>
            <td><c:out value="${mortgage.interestRate}" /></td>
        	    <td width="110"><a href="/Online-Banking-System/AdminMortgageAction?action=delete&nric=<c:out value="${mortgage.nric}"/>"  onclick="">Delete</td>
 			   <td width="135"><a href="/Online-Banking-System/AdminMortgageAction?action=approve&nric=<c:out value="${mortgage.nric}"/>" onclick="">Approve</td>  
  ...
  <tr>
    <td height="21" background="../Resources/Images/imag1.jpg">&nbsp;</td>
  </tr>
</table>
</form>
<script>
