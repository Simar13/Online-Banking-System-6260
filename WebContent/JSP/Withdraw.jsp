...
<body>
<form id="form1" name="form1" method="post" action="/Online-Banking-System/Withdraw" onsubmit="return validateform()">
<table width="100%" height="544" border="0">
  ...
  <tr>
    <td height="320" bgcolor="#F3F4EF"><table width="458" height="160" border="0" align="center">
      <tr>
        <td height="24"><span class="style3">Withdraw</span></td>
      ...
      <tr>
        <td height="24">Select Company for Voucher</td>
