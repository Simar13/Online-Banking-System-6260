...
<table width="100%" height="622" border="0">
 <div> <tr>
  ...
  <tr>
    <td height="28" bgcolor="#F0F0F0" class="cs1"><table width="1027" border="0">
      <tr>
        <td width="503" align="center"><span class="style1"><a href="Profile.jsp">View my profile</a></span></td>
        <td width="508" align="center"><span class="style1"><a href="resetPassword1.jsp">Reset Password</a></span></td>
      </tr>
    </table></td>
  </tr></div>
  <tr >
    <td height="407" bgcolor="#F3F4EF">&nbsp;</td>
  </tr>
  <tr>
