...
<body>
<form id="form1" name="form1" method="post" action="/Online-Banking-System/AdminSearchLoan" onsubmit="return validateform()">
 ...
 <div> 
  ...
  <tr>
    <td height="407" align="center" bgcolor="#F3F4EF"><table width="420" border="0" align="center">
        <tr>
          <td width="201"><span class="style2">View Loan </span></td>
          <td width="203">&nbsp;</td>
        </tr>
        <tr>
          <td>Enter Loan Id</td>
...
var loanid=document.form1.loanid.value; 
