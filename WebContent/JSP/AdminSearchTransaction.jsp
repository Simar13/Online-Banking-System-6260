...
<body>
<form id="form1" name="form1" method="post" action="/Online-Banking-System/AdminSearchTransaction" onsubmit="return validateform()">
 ...
 <div> 
   ...
   <tr>
     <td height="25" bgcolor="#FF0000"><table width="946" border="0" align="center">
         <tr>
           <td width="108" height="36" align="center" class="style1"><a href="/Online-Banking-System/AdminSearchAccount" class="cs1">Search by Account</a></td>
  ...
  <tr>
    <td height="407" align="center" bgcolor="#F3F4EF"><table width="1022" height="414" border="0">
      <tr>
        <td height="50"><table width="718" height="134" border="0" align="center">
          <tr>
            <td width="353" height="24" align="center"><span class="style2">Transactions Details</span></td>
            <td width="349" align="center" valign="middle"><h3>&nbsp;</h3></td>
          </tr>
          <tr>
            <td height="24" align="center">Enter the Account Number</td>
          ...
          <tr>
            ...
            <td align="center" valign="middle"><label>
              <input name="acctdetail" type="submit" class="CsButton" id="acctdetail" value="Submit" />
            </label></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td valign="top"><c:if test="${!empty error}">
			...
			<table style="border:1px outset black;" cellpadding="10">
				...
				<th align="left">Deposit To Account</th>
				...
				<c:forEach items="${transactions}" var="transactions">
 				 <tr>
   			     ...
   			     <td>${transactions.depositToAccount}</td>
