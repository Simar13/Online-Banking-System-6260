...
<table width="100%" height="772" border="0">
 <div> 
  ...
  <tr>
    <td height="557" align="center" bgcolor="#F3F4EF"><p>&nbsp;</p>
      ...
      <tr>
        <td bgcolor="#FF0000"><span class="style2">Update Customer</span></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td width="236">Enter Customer Identity</td>
        <td width="486"><input type="text" name="nric" id="nric" value="${customer.nric}" /></td>
      </tr>
      ...
      <tr>
        <td>Date Of Birth</td>
        <td><input type="text" name="dateofbirth" id="dateofbirth" value="${customer.dateOfBirth}"/></td>
      </tr>
      <tr>
        <td>Nationality</td>
        <td><input type="text" name="nationality" id="nationality" value="${customer.nationality}"/></td>
      </tr>
      <tr>
        <td>Gender</td>
      ...
      <tr>
        <td>User ID</td>
        <td><input type="text" name="userid" id="userid" value="${customer.userid}"/></td>
      </tr>
      <tr>
        <td>Password</td>
        <td><input type="text" name="password" id="password" value="${customer.password}"/></td>
      </tr>
      <tr>
        <td>Date Of Joining</td>
        <td><input type="text" name="dateofjoining" id="dateofjoining" value="${customer.dateOfJoining}" /></td>
      </tr>
      <tr>
        <td>Enter question 1 and answer</td>
        <td>
        <input type="text" name="quest1" id="quest1" size="50" value="${customer.question1}"></input>
       <input type="text" name="answer1" id="answer1" value="${customer.answer1}" ></input>        </td>
      </tr>
      <tr>
        <td>Enter question 2 and answer</td>
        <td><input name="quest2" type="text" id="quest2" value="${customer.question2}" size="50"></input>
            <input type="text" name="answer2" id="answer2" value="${customer.answer2}" /></td>
      </tr>
      <tr>
        <td>Email</td>
      ...
      <tr>
        <td>Status</td>
        <td><input type="text" name="status" id="status" value="${customer.status}"/></td>
      </tr>
      </c:forEach>
    </table>
      <p>&nbsp;</p>
      <table width="200" border="0" align="center">
        <tr>
          <td align="center"><label>
            <input name="Create" type="submit" class="CsButton" id="Create" value="Update" />
          </label></td>
        </tr>
      </table></td>
  </tr>
...
var name=document.form1.name.value;  
 ...
 var dt= /^(\d{4})-(\d{1,2})-(\d{1,2})/;
  ...
  if (nric==null || nric==""){  
  alert("Please Entre the Cutomer id");  
  return false;   
}
