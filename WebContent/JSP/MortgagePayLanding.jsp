  ...
  <tr>
    <td height="407" align="center" bgcolor="#F3F4EF"><p>&nbsp;</p>
      ...
      <c:if test="${!empty error}">
        ...
        <tr>
          <td width="503" align="center"><a href="/Online-Banking-System/MortgageRequest?action=request">Mortgage Request</a></td>
          <td width="505" align="center"><span class="style1"><a href="/Online-Banking-System/MortgagePay">Mortgage Pay</a></span></td>
          <td width="505" align="center"><a href="/Online-Banking-System/MortgageHistoryController">Mortgage History</a></td>
        </tr>
      </table>  
      <p>&nbsp;</p></td>
  </tr>
