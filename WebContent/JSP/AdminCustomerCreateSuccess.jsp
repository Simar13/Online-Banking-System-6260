 ...
 <div> 
  ...
  <tr>
    <td height="557" align="center" bgcolor="#F3F4EF"><p>&nbsp;</p>
      <p>&nbsp;</p>
      <table width="320" height="79" border="0" align="center">
        <tr>
          <td width="314" align="center"><label>Customer created successfully!!</label></td>
        </tr>
...
function Customer() {
	...
	window.location = "AdminCustomerDeactivate.jsp"
	}
	function Update() {
    
	window.location = "AdminCustomerUpdate1.jsp"
	}
...
var name=document.form1.name.value;  
  ...
  return false;   
	...
	/*else if (!numL.test(userid)){ 
       alert("The userid contain only Letters and number and its length should be more than 8");
	return false; 
		}*/
