...
<table width="100%" height="622" border="0">
 <div> 
  ...
  <tr>
    <td height="407" align="center" bgcolor="#F3F4EF"><table width="1024" border="0">
    <c:if test="${!empty error}">
      ...
      <tr>
        <td width="503" align="center"><a href="/Online-Banking-System/LoanRequest?action=request">Loan Request</a></td>
        <td width="505" align="center"><span class="style1"><a href="/Online-Banking-System/LoanPay">Loan Pay</a></span></td>
        <td width="505" align="center"><a href="/Online-Banking-System/LoanHistoryController">Loan History</a></td>
      </tr>
    </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
