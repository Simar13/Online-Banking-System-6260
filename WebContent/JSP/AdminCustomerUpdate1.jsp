...
<body>
<form id="form1" name="form1" method="post" action="/Online-Banking-System/AdminUpdateCustSearch" onsubmit="return validateform()">
<table width="100%" height="772" border="0">
 <div> 
  ...
  <tr>
    <td height="557" align="center" valign="top" bgcolor="#F3F4EF"><p>&nbsp;</p>
    <table width="736" height="40" border="0">
      <tr>
        <td align="left" class="style2">Update Customer</td>
        <td align="center">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="238" align="left">Enter Customer Identity</td>
        <td width="234" align="left"><label>
          <input type="text" name="nric" id="nric" required />
        </label></td>
        <td width="242"><label>
          <input name="searchbutton" type="submit" class="CsButton" id="searchbutton" value="Submit" />
        </label></td>
      </tr>
    </table>      
    <p>&nbsp;</p>
